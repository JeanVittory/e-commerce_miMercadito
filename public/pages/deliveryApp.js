	...
	btnsIncreased.forEach((btn) => {
		btn.addEventListener('click', (e) => {
			...
			const quantityBtnIncreased = document.querySelector(
				`#quantity[data-quantity-Item=cantidad${idBtnIncreased}]`
			);
	...
	btnsDecreased.forEach((btn) => {
		btn.addEventListener('click', (e) => {
			...
			const quantityBtnDecreased = document.querySelector(
				`#quantity[data-quantity-Item=cantidad${idBtnDecreased}]`
			);
			const productToDelete = document.querySelector(
				`#productToDelete[data-delete-Id=id${idBtnDecreased}]`
			);
...
const deleteProducts = () => {
	...
	btnsDelete.forEach((btn) => {
		btn.addEventListener('click', (e) => {
			...
			const productToDelete = document.querySelector(
				`#productToDelete[data-delete-Id=id${idBtnDelete}]`
			);
			if (e.target) {
				sectionProducts.removeChild(productToDelete);
...
const subTotal = () => {
	const sumaTotal = Object.values(productsCart).reduce(
